...
/**
 * Item in *Board Customiser → Wheels*
 */
export interface BoardCustomiserDocumentDataWheelsItem {
  /**
   * Texture field in *Board Customiser → Wheels*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customiser.wheels[].texture
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  texture: prismic.ImageField<never>;

  /**
   * UID field in *Board Customiser → Wheels*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customiser.wheels[].uid
...
/**
 * Item in *Board Customiser → Decks*
 */
export interface BoardCustomiserDocumentDataDecksItem {
  /**
   * Texture field in *Board Customiser → Decks*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customiser.decks[].texture
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  texture: prismic.ImageField<never>;

  /**
   * UID field in *Board Customiser → Decks*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customiser.decks[].uid
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  uid: prismic.KeyTextField;
}
...
/**
 * Item in *Board Customiser → Metals*
 */
export interface BoardCustomiserDocumentDataMetalsItem {
  /**
   * Color field in *Board Customiser → Metals*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customiser.metals[].color
   * - **Documentation**: https://prismic.io/docs/field#color
   */
  color: prismic.ColorField;

  /**
   * UID field in *Board Customiser → Metals*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customiser.metals[].uid
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  uid: prismic.KeyTextField;
}
...
/**
 * Content for Board Customiser documents
 */
interface BoardCustomiserDocumentData {
  /**
   * Wheels field in *Board Customiser*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customiser.wheels[]
   * - **Tab**: Wheels
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  wheels: prismic.GroupField<
    Simplify<BoardCustomiserDocumentDataWheelsItem>
  > /**
   * Decks field in *Board Customiser*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customiser.decks[]
   * - **Tab**: Decks
   * - **Documentation**: https://prismic.io/docs/field#group
   */;
  decks: prismic.GroupField<Simplify<BoardCustomiserDocumentDataDecksItem>> /**
   * Metals field in *Board Customiser*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customiser.metals[]
   * - **Tab**: Metals
   * - **Documentation**: https://prismic.io/docs/field#group
   */;
  metals: prismic.GroupField<Simplify<BoardCustomiserDocumentDataMetalsItem>>;
}

/**
 * Board Customiser document from Prismic
 *
 * - **API ID**: `board_customiser`
 * - **Repeatable**: `false`
 * - **Documentation**: https://prismic.io/docs/custom-types
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type BoardCustomiserDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithoutUID<
    Simplify<BoardCustomiserDocumentData>,
    "board_customiser",
    Lang
  >;
...
interface SkateboardDocumentData {
  ...
  /**
   * Price (pence) field in *Skateboard*
   *
   * - **Field Type**: Number
   * - **Placeholder**: *None*
  ...
  /**
   * Customiser Link field in *Skateboard*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: skateboard.customiser_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  customiser_link: prismic.LinkField<
    string,
    string,
    unknown,
    prismic.FieldState,
...
interface SkaterDocumentData {
  ...
  /**
   * Customiser Link field in *Skater*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: skater.customiser_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  customiser_link: prismic.LinkField<
...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Skateboard truck colour field in *Hero → Default → Primary*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.skateboard_truck_colour
   * - **Documentation**: https://prismic.io/docs/field#color
   */
  skateboard_truck_colour: prismic.ColorField;

  /**
   * Skateboard bolt colour field in *Hero → Default → Primary*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      BoardCustomiserDocument,
      BoardCustomiserDocumentData,
      BoardCustomiserDocumentDataWheelsItem,
      BoardCustomiserDocumentDataDecksItem,
      BoardCustomiserDocumentDataMetalsItem,
      HomepageDocument,
